...
public class SequenceBarBehaviour : MonoBehaviour {
    ...
    private void InitializeCommandsList(bool isMainCommandsList) {
        ...
        AddReorderableListToComponent(sequenceBar, commandsListFlowLayoutGroup, _mainPanel, isMainCommandsList,
                                      isMainCommandsList);
    ...
    public void AddReorderableListToComponent(GameObject component, LayoutGroup contentLayoutGroup,
                                              RectTransform draggableArea, bool isDraggable, bool isRearrangeable) {
